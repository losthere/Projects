...
/**
 * The Interface StoredProcedureService. Generic class used to invoke the stored procedure with
 * params and without params. Also if the procedure return refcursor as output then we can map the
 * result using entity class
 */
public interface StoredProcedureService {
  ...
  Map<String, ? extends Object> callStoredProc(String proc, Map<String, Object> inParams, SqlParameter... params);
}
